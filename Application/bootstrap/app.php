...
$app->register(\Application\Core\Providers\AuthServiceProvider::class);
$app->register(\Application\Core\Providers\CatchAllOptionsRequestsProvider::class);

// Bind for domain model interfaces
$app->register(Application\Core\Providers\DomainServiceProvider::class);
